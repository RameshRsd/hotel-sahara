        ...
        <div class="menu_section" style="margin-bottom: 0;">
            <ul class="nav side-menu">
                ...
                @if(Auth::user()->name =='demo')
                        <li><a disabled="disabled"><i class="fa fa-user"></i> User Control</a></li>
                    @else
                    <li><a href="{{route('addUser')}}"><i class="fa fa-user"></i> User Control</a></li>
                    @endif
                    <li><a href="{{route('addCustomer')}}"><i class="fa fa-user"></i> Guest Entry</a></li>
                    <li><a href="{{route('viewCustomer')}}"><i class="fa fa-user"></i> Guest Details</a></li>
                    <li><a href="{{route('roomBook')}}"><i class="fa fa-briefcase"></i> Room Book</a></li>
                    <li><a href="{{route('roomCheck')}}"><i class="fa fa-spinner fa-pulse"></i> Room Check In</a></li>
                    <li><a href="{{route('Report')}}"><i class="fa fa-align-justify"></i> Reports</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="">
                    ...
                    <ul class="dropdown-menu dropdown-usermenu pull-right" style="color:#2cd2e4;">
                        ...
                        @if(Auth::user()->name =='demo')
                            <li><a href="" disabled="disabled"><i class="fa fa-retweet" aria-hidden="true"> Change Password</i></a></li>
                            @else
