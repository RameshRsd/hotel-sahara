                                                                ...
                                                                @if($floor->id == $room->floor_id && $room->room_type_id == $roomType->id)
                                                                    ...
                                                                    <td style="margin:0; padding:0;">
                                                                        ...
                                                                        @if($room->customer_id == $customerData->id)
                                                                                <a href="{{url('viewCustomer/'.$customerData->id.'/viewCustomerDetails')}}" style="color:#fff; background-color: Red;" class="btn btn-xs">Sold : {{$customerData->name}}</a>
                                                                            @endif
                                                                            @endforeach
                                                                        </div>
                                                                        <div class="col-sm-12 col-xs-12">
                                            ...
                                            <div class="x_content">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    ...
                                                    <table class="table-condensed table-bordered table-hover" style="width: 100%; text-align: center;">
                                                        ...
                                                        @foreach($RoomData as $roomStsCheck)
                                                            @foreach($roomCheck as $key=>$roomSts)
                                                            @if(($roomSts->date === $roomStsCheck->date) && $roomStsCheck->id == $roomSts->room_id &&  $roomStsCheck->customer_id == $roomSts->customer_id)
                                                        <tr>
                                                            {{--<td>{{++$key}}</td>--}}
                                                            <td>{{$roomSts->date}}</td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                        <a href="" style="background-color: Red; color:#fff; padding:5px;">{{$roomStsCheck->room_no}}</a>
                                                            </td>
                                                            <td>
                                                                <a href="" style="background-color: Green; color:#fff; padding:5px;">{{$roomSts->customer->name}}</a>
                                                            </td>
                                                            <td>
                                                                @foreach($district as $districtValue)
                                                                    @if($roomSts->customer->district_id == $districtValue->id && $roomSts->customer->id == $roomSts->customer_id)
                                                                        {{$districtValue->name}}
                                                                    @endif
                                                                @endforeach
                                                            </td>
