                            ...
                            <div class="x_content" style="text-align: center;">
                                <form action="{{url('admin/'.$roomDefaultData->id.'/updateRoomCheck')}}" data-parsley-validate method="post"
                                    ...
                                    <div class="col-md-2 col-sm-2 col-xs-12" style="margin:5px 0;">
                                        <select name="guest_id" id="guest_id" class=" input-sm form-control">
                                            <option value="0" selected="true">[Select Guest ID]</option>
                                            @foreach($CustomeData as $value)
                                                <option value="{{$value->id}}">{{$value->id}}->{{$value->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-2 col-sm-2 col-xs-12" style="margin:5px 0;">
                                        <select name="customer_id" id="guest_name" class="form-control input-sm" required="required">
